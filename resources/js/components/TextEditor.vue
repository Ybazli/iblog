...
<template>
    <div style="position: relative">
            ...
            <div class="controls hidden pl-4 bg-contrast">
                <button @click="openImageUploader()"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 20 20" class="fill-current w-3">
                ...
                <button @click="$emit('openingHTMLEmbedder')" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 20 20" class="fill-current w-3">
                ...
                <button @click="addDivider" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 20 20" class="fill-current w-3">
        ...
        <div ref="editor" class="bg-white p-5"></div>

        <image-uploader post-id="postId"
                        @updated="applyImage"></image-uploader>
        <html-embedder post-id="postId"
                       @adding="addHTML"></html-embedder>
    </div>
</template>
